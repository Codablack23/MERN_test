...
const OpenDemo = () => {
    return ( 
      <div>
          <h3 className="w3-text-purple" style={{paddingLeft:"2%"}} >Create Demo Account</h3>
            <div className="open_demo_form p-2 pt-5 pb-5 w3-card">
            <h4 className="w3-text-purple w3-center">Add Demo Account Information</h4>
              <form className="demo_form">
                  ...
                  <input className=" w3-text-grey" type="number" placeholder="Choose Starting amount" min="50" max="10000"/><br /><br />
